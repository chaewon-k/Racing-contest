...
class DrivingClient(DrivingController):
    ...
    def checking_obstacle(self,sensing_info):
        ...
        obstacle_distance = sensing_info.track_forward_obstacles[0]['distance']
    ...
    def obstacle_avoid(self, sensing_info):
        ...
        forward_obstacles = []
        not_available_pos = []
       s for obstacle in obstacle_lit:
    ...
    def control_driving(self, car_controls, sensing_info):
        ...
        if sensing_info.speed < 100:
            ...
            angle_num += 15
        if angle_num > 19: angle_num = 19

        avoid_check = 0
        if sensing_info.track_forward_obstacles and checking_obstacle(sensing_info):
            avoid_check = 1
        else:
